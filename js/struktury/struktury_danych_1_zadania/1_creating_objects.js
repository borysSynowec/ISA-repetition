...
let superman = {
  ...
  sayRealName:function(){return 'I am'+ this.alterEgo + 'from'+ this.origin +'!'},
  setStrength:function(newstrenght){superman.strength === newstrenght},
  kick:function(){return this.strength*1.2},
  punch:function(){return this.strength*0.7},
  combo:function(){return this.kick()+this.punch()},
  isFastHero:function(){return this.speed > 100}
}
